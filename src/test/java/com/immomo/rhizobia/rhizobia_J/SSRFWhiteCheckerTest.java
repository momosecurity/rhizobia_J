...
public class SSRFWhiteCheckerTest {

    public SSRFWhiteChecker urlChecker;
    ...
    public void beforeClass() throws Exception {
        ...
        //选择适当的构造函数
        urlChecker = SSRFWhiteChecker.getInstance();
        urlChecker.setWhiteList(whitelist);
//        System.out.println(urlChecker.getWhiteList());
//        urlChecker.addWhiteList(whitelist);
//        System.out.println(urlChecker.getWhiteList());
    }
